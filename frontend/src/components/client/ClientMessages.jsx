...
import { ArrowRight, Search, Phone, Video } from 'lucide-react';
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#f5f5f5' }}>
          {currentConversation ? (
            ...
            <div style={{ textAlign: 'center', marginTop: '100px' }}>
              ...
              <button 
                onClick={() => navigate('/client/search')}
                style={{ marginTop: 16, padding: '10px 20px', background: '#3498db', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
              >
                ابحث عن عامل
              </button>
            </div>
