...
} from '../../features/messages/messagesSlice'; // ✅ المسار الصحيح
import '../../styles/Dashboard.css';

export default function ClientMessages() {
  const dispatch = useDispatch();
  const { conversations = [], currentConversation = null, messages = {}, isLoading = false } = useSelector((state) => state.messages) || {};
          ...
          {currentConversation ? (
            <>
              <div className="msg-topbar">
                ...
                <div>
                  <div className="msg-conv__name">{currentConversation.participant?.name}</div>
              ...
              <div className="msg-body">
                {currentMessages.length === 0 ? (
                  ...
                  currentMessages.map((msg, idx) => {
                    ...
                    return (
                      <div key={idx} className={`msg-bubble msg-bubble--${isMe ? 'me' : 'them'}`}>
                        <div className={`msg-text msg-text--${isMe ? 'me' : 'them'}`}>{msg.message}</div>
              ...
              <div className="msg-input">
                <textarea
                  ...
                  rows={1}
                />
                <button className="msg-send" onClick={handleSend} disabled={sending || !newMessage.trim()}>
